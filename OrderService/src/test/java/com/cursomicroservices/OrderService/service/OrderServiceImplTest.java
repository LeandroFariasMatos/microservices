...
import com.cursomicroservices.OrderService.exception.CustomException;
import com.cursomicroservices.OrderService.external.client.PaymentService;
import com.cursomicroservices.OrderService.external.client.ProductService;
import com.cursomicroservices.OrderService.external.request.PaymentRequest;
import com.cursomicroservices.OrderService.external.response.PaymentResponse;
...
import com.cursomicroservices.OrderService.model.PaymentMode;
import com.cursomicroservices.OrderService.repository.OrderRepository;
...
public class OrderServiceImplTest {
    ...
    @DisplayName("Get Order - Successful Scenario")
    @Test
    void test_When_Order_Sucess(){
    ...
    void test_When_Place_Order_Success(){
        ...
        when(paymentService.doPayment(any(PaymentRequest.class)))
                .thenReturn(new ResponseEntity<Long>(1L,HttpStatus.CREATED));
